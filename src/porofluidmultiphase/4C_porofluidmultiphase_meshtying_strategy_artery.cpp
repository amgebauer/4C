...
/*----------------------------------------------------------------------*
 ...
 |                                                     kremheller 04/18 |
 *----------------------------------------------------------------------*/
void POROFLUIDMULTIPHASE::MeshtyingStrategyArtery::update() { artnettimint_->time_update(); }
 ...
 *------------------------------------------------------------------------ */
void POROFLUIDMULTIPHASE::MeshtyingStrategyArtery::setup() { arttoporofluidcoupling_->setup(); }
