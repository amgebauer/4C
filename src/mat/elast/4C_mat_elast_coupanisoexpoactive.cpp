...
//     Core::LinAlg::Matrix<4, 1, FAD>&, Core::LinAlg::SymmetricTensor<FAD, 3, 3> const&, int, const
//     int) const;
...
//     Core::LinAlg::SymmetricTensor<FAD, 3, 3> const&, Core::LinAlg::SymmetricTensor<FAD, 3, 3, 3,
//     3>&, Core::LinAlg::SymmetricTensor<FAD, 3, 3>&, int, const int) const;
